...
if __name__ == "__main__":
    ...
    # === BỔ SUNG: đo inference time trung bình cho 1 transaction ===
    model.eval()
    total_inf_time = 0.0
    total_samples  = 0
    ...
    if total_samples > 0:
        avg_inf = total_inf_time / total_samples
        print(f"Inference time per transaction: {avg_inf * 1000:.3f} ms")
    else:
        print("Chưa có sample để đo inference.")
