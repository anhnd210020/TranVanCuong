...
class Shift_gcn(nn.Module):
    ...
    def forward(self, x0, edge_index=None):
        # x0: (n, t, v, c) -> chuyển sang (n, c, t, v)
...
# Với giả định tổng số unique cc_num bằng 999, ta chia 800 user cho training và 199 user cho testing.
...
# Nếu tồn tại cột trans_num thì drop cột này khỏi cả train và test
...
# Thêm cột 'is_fraud' vào DataFrame đã scale cho train và test
