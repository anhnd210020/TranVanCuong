...
# =======================================================
# 0. Định nghĩa Focal Loss
# =======================================================
class FocalLoss(nn.Module):
    def __init__(self, alpha=0.25, gamma=2, reduction='none'):
        """
        alpha: trọng số cho lớp dương (để cân bằng dữ liệu)
        gamma: tham số điều chỉnh độ khó của mẫu
        reduction: cách giảm tổng loss ('none' để tính loss theo từng mẫu, xử lý tổng hợp ở ngoài)
        """
    ...
    def forward(self, inputs, targets):
        # inputs: output sau sigmoid, kích thước (batch_size)
        # targets: kích thước (batch_size)
...
# =======================================================
# 0.1. Định nghĩa Combined Loss: BCE + FocalLoss
# =======================================================
class CombinedLoss(nn.Module):
    def __init__(self, alpha=0.25, gamma=2, bce_weight=1.0, focal_weight=1.0, reduction='mean'):
        """
        bce_weight: trọng số cho BCE Loss
        focal_weight: trọng số cho Focal Loss
        """
...
# =======================================================
# 4. Định nghĩa mô hình FraudLSTM với nhấn mạnh các features day_of_week và hour
# =======================================================
